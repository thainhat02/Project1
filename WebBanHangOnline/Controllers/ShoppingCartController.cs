        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    order.TotalAmout = cart.items.Sum(x => (x.Price * x.Quantity));
                    ...
                    TongTien = thanhtien;
                    string contentCustomer = System.IO.File.ReadAllText(Server.MapPath("~/Content/TemplateSenadMail/send2.html"));
                    ...
                    string contentAdmin = System.IO.File.ReadAllText(Server.MapPath("~/Content/TemplateSenadMail/send1.html"));
